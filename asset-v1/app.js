...
var app = new function() {
    this.name = "Battle", this.version = "1", this.date = "2023", this.folder = "asset-v1/", this.looptime = 8727, this.bpm = 110, this.totalframe = 202, this.nbpolo = 7, this.nbloopbonus = 2, this.bonusloopA = !1, this.bonusendloopA = !1, this.recmaxloop = 34, this.recminloop = 4, this.recmintime = Math.round(this.looptime / 1e3) * this.recminloop, this.spritepolo = "polo-sprite.png", this.spritepicto = "game-picto.png", this.colBck = "#7905ff", this.col0 = "#7905ff", this.col1 = "#7905ff", this.col2 = "#7905ff", this.col3 = "#320169", this.col4 = "#7905ff", this.animearray = [{
        name: "1_kicker",
        color: "FF66A8",
        uniqsnd: !0
    }, {
